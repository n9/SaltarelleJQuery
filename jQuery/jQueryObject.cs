...
namespace jQueryApi {
	...
	public class jQueryObject {
		...
		/// <returns>The current jQueryObject.</returns>
		public jQueryObject Animate(JsDictionary propertiesToAnimate) {
			return null;
		}
		...
		/// <returns>The current jQueryObject.</returns>
		public jQueryObject Animate(JsDictionary propertiesToAnimate, JsDictionary options) {
			return null;
		}
		...
		/// <returns>The current jQueryObject.</returns>
		[ScriptName("attr")]
		public jQueryObject Attribute(JsDictionary nameValueMap) {
			return null;
		}
		...
		/// <param name="eventHandler">The event handler to be invoked.</param>
		/// <returns>The current jQueryObject</returns>
		public jQueryObject Bind(string eventName, JsDictionary eventData, jQueryEventHandler eventHandler) {
			return null;
		}
		...
		/// <returns>The current jQueryObject.</returns>
		[ScriptName("css")]
		public jQueryObject CSS(JsDictionary nameValueMap) {
			return null;
		}
		...
		/// <returns>The current jQueryObject.</returns>
		public jQueryObject Data(JsDictionary data) {
			return null;
		}
		...
		/// <summary>
		/// Triggers the focusin event on each of the matched set of elements.
		/// </summary>
		/// <returns>The current jQueryObject</returns>
		[ScriptName("focusin")]
		public jQueryObject FocusIn() {
			return null;
		}
		...
		/// <summary>
		/// Triggers the focusout event on each of the matched set of elements.
		/// </summary>
		/// <returns>The current jQueryObject</returns>
		[ScriptName("focusout")]
		public jQueryObject FocusOut() {
			return null;
		}
		...
		/// <summary>
		/// Triggers the mousedown event on each of the matched set of elements.
		/// </summary>
		/// <returns>The current jQueryObject</returns>
		[ScriptName("mousedown")]
		public jQueryObject MouseDown() {
			return null;
		}
		...
		/// <returns>The current jQueryObject</returns>
		[ScriptName("mousedown")]
		public jQueryObject MouseDown(JsDictionary eventData) {
			return null;
		}
		...
		/// <returns>The current jQueryObject</returns>
		[ScriptName("mousedown")]
		public jQueryObject MouseDown(JsDictionary eventData, jQueryEventHandler eventHandler) {
			return null;
		}
		...
		public jQueryObject MouseEnter() {
			return null;
		}
		...
		/// <summary>
		/// Triggers the mouseleave event on each of the matched set of elements.
		/// </summary>
		/// <returns>The current jQueryObject</returns>
		[ScriptName("mouseleave")]
		public jQueryObject MouseLeave() {
			return null;
		}
		...
		/// <summary>
		/// Triggers the mousemove event on each of the matched set of elements.
		/// </summary>
		/// <returns>The current jQueryObject</returns>
		[ScriptName("mousemove")]
		public jQueryObject MouseMove() {
			return null;
		}
		...
		/// <summary>
		/// Triggers the mouseout event on each of the matched set of elements.
		/// </summary>
		/// <returns>The current jQueryObject</returns>
		[ScriptName("mouseout")]
		public jQueryObject MouseOut() {
			return null;
		}
		...
		/// <summary>
		/// Triggers the mouseover event on each of the matched set of elements.
		/// </summary>
		/// <returns>The current jQueryObject</returns>
		[ScriptName("mouseover")]
		public jQueryObject MouseOver() {
			return null;
		}
		...
		/// <summary>
		/// Triggers the mouseup event on each of the matched set of elements.
		/// </summary>
		/// <returns>The current jQueryObject</returns>
		[ScriptName("mouseup")]
		public jQueryObject MouseUp() {
			return null;
		}
		...
		/// </summary>
		/// <param name="elements">The jQuery object representing the elements to remove.</param>
		/// <returns>The new jQueryObject.</returns>
		public jQueryObject Not(jQueryObject elements) {
			return null;
		}
		...
		/// <returns>The current jQueryObject.</returns>
		public jQueryObject Off(JsDictionary eventsMap) {
			return null;
		}
		...
		/// <returns>The current jQueryObject.</returns>
		public jQueryObject Off(JsDictionary eventsMap, string selector) {
			return null;
		}
		...
		/// <returns>The current jQueryObject</returns>
		public jQueryObject On(JsDictionary eventsMap) {
			return null;
		}
		...
		/// <param name="selector">A selector string to filter the descendants of the selected elements that trigger the event.</param>
		/// <returns>The current jQueryObject</returns>
		public jQueryObject On(JsDictionary eventsMap, string selector) {
			return null;
		}
		...
		/// <param name="data">A custom data structure to be passed to the handler</param>
		/// <returns>The current jQueryObject</returns>
		public jQueryObject On(JsDictionary eventsMap, string selector, object data) {
			return null;
		}
		...
		public IjQueryPromise<T> Promise<T>()
		{
			return null;
		}
		...
		/// <returns>A deferred object.</returns>
		public IjQueryPromise<T> Promise<T>(string type)
		{
			return null;
		}
		...
		public IjQueryPromise<T> Promise<T>(string type, object target)
		{
			return null;
		}
		...
		/// <summary>
		/// Triggers the scroll event on each of the matched set of elements.
		/// </summary>
		/// <returns>The current jQueryObject</returns>
		public jQueryObject Scroll() {
			return null;
		}
		...
		/// <returns>The current jQueryObject.</returns>
		public jQueryObject ToggleClass(string className, bool add) {
			return null;
		}
		...
		/// <param name="add">true if the class should be added; false otherwise.</param>
		/// <returns>The current jQueryObject.</returns>
		public jQueryObject ToggleClass(StringFunction cssFunction, bool add) {
			return null;
		}
