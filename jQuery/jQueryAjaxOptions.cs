...
namespace jQueryApi {
	...
	[Imported]
	[Serializable]
	public sealed class jQueryAjaxOptions<T> {
		...
		/// </summary>
		public AjaxSendingCallback<T> BeforeSend {
			get {
				return null;
			}
			set {
		...
		/// </summary>
		public AjaxCompletedCallback<T> Complete {
			get {
				return null;
			}
			set {
		...
		/// </summary>
		public AjaxErrorCallback<T> Error {
			get {
				return null;
			}
			set {
		...
		/// </summary>
		public AjaxRequestCallback<T> Success {
			get {
				return null;
			}
			set {
		...
		/// </summary>
		[ScriptName("xhr")]
		public XmlHttpRequestCreator<T> XmlHttpRequestCreator {
			get {
				return null;
			}
			set {
